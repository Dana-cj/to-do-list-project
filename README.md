...
- **Email notifications**: Email notifications are sent 24 h before the due date of the task. 
...
Create a MySQL database and update the `context.xml` with the appropriate database connection settings.
...
4. Start Tomcat and access the application at `http://localhost:8080/todo`
